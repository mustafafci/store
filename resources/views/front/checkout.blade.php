                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="single-form form-default">
                                                    <x-form.label label="User Name" />
                                                    <div class="row">
                                                        <div class="col-md-6 form-input form">
                                                            <x-form.input name="address[billing][first_name]"
                                                                placeholder="First Name" aria-autocomplete="on" />
                                                        </div>
                                                        <div class="col-md-6 form-input form">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <x-form.input name="address[billing][email]" type="email"
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <x-form.input name="address[billing][phone]"
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>City</label>
                                                    <div class="form-input form">
                                                        <x-form.input name="address[billing][city]" placeholder="City" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Country</label>
                                                    <div class="form-input form">
                                                        <x-form.input name="address[billing][country]"
                                                            placeholder="Country" />
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <x-form.label label="Email Address" />
                                                    <div class="form-input form">
                                                        <x-form.input name="address[shipping][email]" type="email"
                                                            placeholder="Email Address" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Phone Number</label>
                                                    <div class="form-input form">
                                                        <x-form.input name="address[shipping][phone]"
                                                            placeholder="Phone Number" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>State</label>
                                                    <div class="form-input form">
                                                        <x-form.input name="address[shipping][state]"
                                                            placeholder="state" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Country</label>
                                                    <div class="form-input form">
                                                        <x-form.input name="address[shipping][country]"
                                                            placeholder="Country" />
                                                    </div>
                                                </div>
                                            </div>
